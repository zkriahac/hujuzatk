...
const content = {
  ...
  ar: {
    ...
    hero: {
      ...
      title1: 'أدر عقاراتك',
      mark: 'من تقويم واحد',
      subtitle: 'تابع الحجوزات، أصدر فواتير عربية، سجّل المصروفات، واطّلع على إيرادات كل غرفة — من أي هاتف. اربط Airbnb وBooking.com وجاثرين عند الحاجة.',
    ...
    logos: { intro: 'نتكامل مع المنصات الكبرى', items: ['Airbnb', 'Booking.com', 'جاثرين'] },
    features: {
      eyebrow: 'مميزات قوية',
    ...
    f: [
      ...
      { tag: '٠٧', title: 'مزامنة تلقائية للقنوات', desc: 'مزامنة ليلية وعند الطلب لتقويم Airbnb وجاثرين وBooking.com. الحجوزات الجديدة تظهر تلقائياً — دون أي نسخ ولصق.', color: 'coral' },
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['30 غرفة', 'مزامنة Airbnb تلقائية', 'مزامنة جاثرين تلقائية', 'مزامنة Booking.com تلقائية', 'مزامنة ليلية مجدولة', 'دعم أولوية'],
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'هل يمكنني استيراد حجوزاتي الحالية؟', a: 'نعم. ارفع ملف CSV أو ألصق حجوزاتك الحالية — نطابق الغرف تلقائياً. مستخدمو خطة المحترف يربطون Airbnb و Booking.com وجاثرين بنقرة واحدة.' },
...
function ChannelsHolo({ lang }: { lang: Lang }) {
  const channels = [
    ...
    { t: lang === 'ar' ? 'جاثرين' : 'Gathern', color: 'var(--brand-green)', rot: -3, x: 140, y: 30 },
  ];
  return (
...
function applySEO(lang: Lang) {
  ...
  setJsonLD('software', {
    ...
    featureList: isAr
      ? ['تقويم حجوزات 3 سنوات', 'فوترة PDF تلقائية', 'دعم العربية RTL', 'تحليلات مالية', 'تتبع المصروفات', 'تطبيق جوال قابل للتثبيت', 'تكامل قنوات (Airbnb / جاثرين / Booking.com)']
