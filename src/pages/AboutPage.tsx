...
const COPY = {
  ...
  ar: {
    ...
    sections: [
      ...
      { Icon: Heart, head: 'لماذا بنيناه', body: 'الأدوات الموجودة إما مصممة للسلاسل الفندقية (ثقيلة ومكلفة) أو للأسواق الغربية (بدون عربية، بدون تواريخ هجرية، بدون تكامل مع جاثرين). بدأنا حجوزاتك لنعطي مديري العقارات المستقلين في السعودية والخليج وما بعدها أداة تناسبهم.' },
